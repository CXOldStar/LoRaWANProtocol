...
class AbsortObject:
    def __init__(self, mtype, dev_addr, mac_command, lorawan_mac_test, app_payload, fcnt, ack,
    ...
    def generate(phypayload_init, do_mic_check=None, do_decrypto_check=None):
        ...
        return AbsortObject(mtype=mtype, dev_addr=dev_addr, mac_command=mac_command,
            lorawan_mac_test=lorawan_mac_test, app_payload=app_payload, fcnt=fcnt, ack=ack,
