...
class PHYPayload:
    ...
    def analysis(phypayload, NwkSKey=None, AppSKey=None, AppKey=None, dev_nonce=None):
        """
        NwkSKey: Network session key is used to compute the mic value and decrypto/encrypto the frmpayload
                 containing a mac command.
        AppSKey: Application session key is used to decrypto/encrypto the frmpayload containing payload data
                 of application layer.
        AppKey: Application Key is used to decrpto/encrypto the join accept message and compute the mic of
                join accept message. It is also used to compute the NwkSKey and AppSKey.
        dev_nonce: It is generated by device and used to compute NwkSKey and AppSKey.
        """
        mhdr = phypayload[0]
        mic = phypayload[-4:]
